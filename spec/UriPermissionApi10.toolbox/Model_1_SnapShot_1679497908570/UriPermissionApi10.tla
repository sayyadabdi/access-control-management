...
*************)             
\* BEGIN TRANSLATION (chksum(pcal) = "a8f83767" /\ chksum(tla) = "4d579e90")
...
\* Parameter app of procedure askPermission at line 59 col 29 changed to app_a
...
UPDATE_APP(self) == /\ pc[self] = "UPDATE_APP"
                    ...
                    /\ UNCHANGED << CP, installed, appPerms, permsInUse, 
                                    cpUserConsent, appPermConsents, 
                                    appCustomPerms, stack, app_, app_d, app_s, 
