...
*************)             
\* BEGIN TRANSLATION (chksum(pcal) = "5dc67cdc" /\ chksum(tla) = "1ec45e55")
...
vars == << CP, installed, appPerms, permsInUse, cpUserConsent, 
           appPermConsents, appCustomPerms, pc, stack, app_, app_d, a1_, a2_, 
           app_u, a1, a2, app_un, app_s, perm_, app, perm >>
...
DEFINE_CP(self) == /\ pc[self] = "DEFINE_CP"
                   ...
                   /\ UNCHANGED << installed, appPerms, permsInUse, 
                                   ...
                                   appCustomPerms, app_, a1_, a2_, app_u, a1, 
                                   a2, app_un, app_s, perm_, app, perm >>
...
RETURNING(self) == /\ pc[self] = "RETURNING"
                   ...
                   /\ UNCHANGED << CP, installed, appPerms, permsInUse, 
                                   cpUserConsent, appPermConsents, 
                                   appCustomPerms, app_, app_d, a1_, a2_, a1, 
                                   a2, app_un, app_s, perm_, app, perm >>
...
PLATFORM(self) == /\ pc[self] = "PLATFORM"
                  ...
                  /\ UNCHANGED << CP, installed, appPerms, permsInUse, 
                                  cpUserConsent, appPermConsents, 
                                  appCustomPerms, a1_, a2_, app_s, perm_ >>
...
\* Last modified Wed Mar 22 18:49:55 GMT+03:30 2023 by Amirhosein
