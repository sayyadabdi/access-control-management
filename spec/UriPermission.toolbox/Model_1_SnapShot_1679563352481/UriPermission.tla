...
*************)             
\* BEGIN TRANSLATION (chksum(pcal) = "1eb5eaf7" /\ chksum(tla) = "30718465")
...
CLEARING(self) == /\ pc[self] = "CLEARING"
                  ...
                  /\ UNCHANGED << installed, permsInUse, stack, app_, app_s, 
...
\* Last modified Thu Mar 23 12:52:27 GMT+03:30 2023 by Amirhosein
