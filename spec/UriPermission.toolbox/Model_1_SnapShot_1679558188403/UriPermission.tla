...
*************)             
\* BEGIN TRANSLATION (chksum(pcal) = "886d84a9" /\ chksum(tla) = "4bf62fed")
...
UNINSTALL_APP(self) == /\ pc[self] = "UNINSTALL_APP"
                       ...
                       /\ stack' = [stack EXCEPT ![self] = Tail(stack[self])]
                       /\ UNCHANGED << permsInUse, app_, app_s, perm_, app_a, 
                                       perm >>
...
\* Last modified Thu Mar 23 11:26:21 GMT+03:30 2023 by Amirhosein
