...
--algorithm PermissionManager
{
    ...
    {
        CLEARING:      appPerms[app] := [i \in Apps |-> [p \in Perms |-> NULL]];
...
*************)             
\* BEGIN TRANSLATION (chksum(pcal) = "da4e23ed" /\ chksum(tla) = "7f455111")
...
CLEARING(self) == /\ pc[self] = "CLEARING"
                  /\ appPerms' = [appPerms EXCEPT ![app[self]] = [i \in Apps |-> [p \in Perms |-> NULL]]]
                  ...
                  /\ UNCHANGED << installed, stack, app_, app_s, perm_, app_a, 
                                  perm, app >>
...
\* Last modified Thu Mar 23 11:33:05 GMT+03:30 2023 by Amirhosein
