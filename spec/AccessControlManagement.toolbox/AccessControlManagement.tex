...
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} Apps ,\, Perms}%
\@pvspace{8.0pt}%
\@x{ NULL \.{\defeq}\@w{NULL}}%
\@x{ ALLOW \.{\defeq}\@w{ALLOW}}%
\@x{ REJECT \.{\defeq}\@w{REJECT}}%
\@pvspace{8.0pt}%
\@x{ Boolean\@s{1.57} \.{\defeq} \{ {\TRUE} ,\, {\FALSE} \}}%
\@x{ Consent \.{\defeq} \{ ALLOW ,\, REJECT \}}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLE} ACL ,\, Resource}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} \.{\land} \A\, a \.{\in} Apps \.{:} \A\, p \.{\in}
 Perms \.{:} \.{\land} ACL [ a ] [ p ] \.{\in} Consent \.{\cup} \{ NULL \}}%
\@x{\@s{187.90} \.{\land} Resource [ a ] [ p ] \.{\in} Boolean}%
\@pvspace{8.0pt}%
 \@x{ decide ( a ,\, p ) \.{\defeq} \.{\land} \E\, c\@s{11.02} \.{\in} Consent
 \.{:}}%
 \@x{\@s{82.83} ACL \.{'} \.{=} [ ACL {\EXCEPT} {\bang} [ a ] \.{=} [ ACL [ a
 ] {\EXCEPT} {\bang} [ p ] \.{=} c ] ]}%
\@pvspace{8.0pt}%
 \@x{ use ( a ,\, p )\@s{0.06} \.{\defeq} \.{\land} ACL [ a ] [ p ] \.{=}
 ALLOW}%
 \@x{\@s{59.27} \.{\land} Resource \.{'}\@s{1.43} \.{=} [ Resource {\EXCEPT}
 {\bang} [ a ] \.{=} [ Resource [ a ] {\EXCEPT} {\bang} [ p ] \.{=} {\TRUE} ]
 ]}%
\@x{\@s{59.27} \.{\land} {\UNCHANGED} {\langle} ACL {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ask ( a ,\, p ) \.{\defeq} {\IF} ACL [ a ] [ p ] \.{=} NULL}%
\@x{\@s{71.42} \.{\THEN} \.{\land} decide ( a ,\, p )}%
\@x{\@s{102.74} \.{\land} {\UNCHANGED} {\langle} Resource {\rangle}}%
\@x{\@s{59.27} \.{\ELSE}}%
\@x{\@s{71.57} \.{\land} {\UNCHANGED} {\langle} ACL ,\, Resource {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Init\@s{4.12} \.{\defeq} \.{\land} ACL \.{=} [ a \.{\in} Apps
 \.{\mapsto} [ p \.{\in} Perms \.{\mapsto} NULL ] ]}%
 \@x{\@s{39.83} \.{\land} Resource\@s{3.49} \.{=} [ a \.{\in} Apps \.{\mapsto}
 [ p \.{\in} Perms \.{\mapsto} {\FALSE} ] ]}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} \.{\lor} \E\, a \.{\in} Apps \.{:} \E\, p \.{\in} Perms
 \.{:} \.{\lor} ask ( a ,\, p )}%
\@x{\@s{171.59} \.{\lor} use ( a ,\, p )}%
\@pvspace{8.0pt}%
\@x{ vars\@s{2.10} \.{\defeq} {\langle} ACL ,\, Resource {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Authorized \.{\defeq} {\Box} {\lnot} ( \.{\land} \E\, a \.{\in} Apps
 \.{:} \E\, p \.{\in} Perms \.{:}}%
\@x{\@s{95.72} \.{\land} Resource [ a ] [ p ] \.{=} {\TRUE}}%
\@x{\@s{95.72} \.{\land} ACL [ a ] [ p ] \.{\neq} ALLOW )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 23 14:10:47 \ensuremath{GMT}+03:30 2023 by
