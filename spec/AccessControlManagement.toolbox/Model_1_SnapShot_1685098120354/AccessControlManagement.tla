...
***)
\* BEGIN TRANSLATION (chksum(pcal) = "fef661b1" /\ chksum(tla) = "9bb3f98b")
...
AcmNext(self) == b323(self) \/ f(self) \/ a(self) \/ b(self) \/ c(self)
                    \/ d(self) \/ N(self)
...
\* Last modified Fri May 26 14:18:35 GMT+03:30 2023 by Amirhosein
