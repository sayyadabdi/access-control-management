...
***)
\* BEGIN TRANSLATION (chksum(pcal) = "a6632390" /\ chksum(tla) = "6b07fe63")
...
AcmNext(self) == b323(self) \/ dsd(self) \/ f(self) \/ a(self) \/ b(self)
...
\* Last modified Fri May 26 14:17:29 GMT+03:30 2023 by Amirhosein
