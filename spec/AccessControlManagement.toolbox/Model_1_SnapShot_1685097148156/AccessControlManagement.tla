...
***)
\* BEGIN TRANSLATION (chksum(pcal) = "c3238dce" /\ chksum(tla) = "c811d9c5")
...
AcmNext(self) == AcmBegin(self) \/ dsd(self) \/ f(self) \/ H(self)
                    \/ a(self) \/ b(self) \/ c(self) \/ d(self) \/ J(self)
...
\* Last modified Fri May 26 14:02:19 GMT+03:30 2023 by Amirhosein
